import { Box, Button, Center, FormControl, FormErrorMessage, FormHelperText, FormLabel, Heading, Input, Stack, Textarea, useToast } from '@chakra-ui/react'
...
const Profile = () => {
  ...
  return (
    <Stack direction="row" w={['100vw', '', "100%"]} minH='100vh'>
      <Box pos="fixed" w={['0', '', '']}>
        <Sidebar />
      </Box>
      <Box
